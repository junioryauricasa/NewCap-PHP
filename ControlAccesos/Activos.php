...
if ($_SESSION['usuario']) {
	...
	<title>New Capital - Activos</title>
					...
					<div class="panel panel-default" id="importacion">
						<div class="panel-heading">
							<strong><span id="omenu" class="fa fa-chevron-circle-left"></span>
								Activos</strong> <span class="pull-right"><span
							...
							<div class="nav">
								<nav id="bprincipal" class="navbar navbar-default navbar-inverse"
									...
									<div class="navbar-collapse  navbar-filter">
											...
											data-toggle="modal" href="#" onclick="AbrirPopupCrearActivo()"> <span
											class="fa fa-user-plus"></span> Crear Activos
										</a> &nbsp;&nbsp; 
									</div>
									<br>
								</nav>	
								...
								<table id="principal"
									...
									?>	
										<tr>
											...
											<td>
											<a href=# onclick="AbrirPopupEliminar(<?php echo$var['idActivo']; ?>)">
					...
					<div class="modal-body" style="padding-bottom: 0px !important;">
						...
						<form class="bs-example form-horizontal u-action-error">
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" id="txtCodigoActivo" class="form-control">
								</div>
							</div>	
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label" style="width: 150px; margin-left: 100px;">Nombre:</label>
								<div class="col-lg-4">
									<input type="text" id="txtNombreActivo" class="form-control">
								</div>
							</div>	
	...
	function AbrirPopupCrearActivo()
	{
	...
	{
		var CodigoActivo = $('#txtCodigoActivo').val();
		var NombreActivo = $('#txtNombreActivo').val();
		var accion = "CrearActivo";
		debugger;
		if(CodigoActivo!="" && NombreActivo !="" )
		{
			var parametros = {"accion":accion,"CodigoActivo":CodigoActivo,"NombreActivo":NombreActivo};

			$.ajax({
			        data:  parametros,
			        url:   'Controlador/ActivoController.php',
			        type:  'post',
	...
	function AbrirPopupEliminar(idActivo)
	{
		var answer = confirm("Esta Seguro que quiere eliminar el Activo?")
		if (answer){
			var accion = "EliminarActivo";
		    var parametros = {"accion":accion,"idActivo":idActivo};
			$.ajax({
				data:  parametros,
				url:   'Controlador/ActivoController.php',
				type:  'post',
