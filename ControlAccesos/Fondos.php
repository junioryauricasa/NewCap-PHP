...
if ($_SESSION['usuario']) {
	...
	<div class="col-md-10" id="contenedorprincipal">
					<div class="panel panel-default" id="importacion">
						<div class="panel-heading">
							<strong><span id="omenu" class="fa fa-chevron-circle-left"></span>
								Fondos</strong> <span class="pull-right"><span
							...
							<div class="nav">
								<nav id="bprincipal" class="navbar navbar-default navbar-inverse"
									...
									<div class="navbar-collapse  navbar-filter">
											...
											data-toggle="modal" href="#" onclick="AbrirPopupCrearFondo()"> <span
											class="fa fa-user-plus"></span> Crear Fondo
										</a> &nbsp;&nbsp; 
									</div>
									<br>
								</nav>	
								...
								<table id="principal"
									...
									?>	
										<tr>
											...
											<td><?php echo$var['valorcuota']; ?></td>
											<?php $NumUsuarios = $Fondo->ObtenerNumeroClientes($var['idFondos']); ?>
											<td><?php echo$NumUsuarios['NumeroClientes']; ?></td>
											<td>
												<a href=# onclick="AbrirPopupHistorial(<?php echo$var['idFondos']; ?>)">
													<i class="fa fa-database"> </i>
												</a>
											</td>
											<td>
												<?php
												if($NumUsuarios['NumeroClientes'] > 0){?>
													-
												<?php } 
												 else{ ?>	
													<a href=# onclick="AbrirPopupEliminar(<?php echo$var['idFondos']; ?>)">
					...
					<div class="modal-body" style="padding-bottom: 0px !important;">
						...
						<form class="bs-example form-horizontal u-action-error">
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label" style="width: 150px; margin-left: 100px;">Nombres Fondo:</label>
								<div class="col-lg-4">
									<input type="text" id="txtNombreFondo" class="form-control">
								</div>
							</div>	
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label" style="width: 150px; margin-left: 100px;">Valor Cuota Inicial:</label>
								<div class="col-lg-4">
									<input type="text" id="txtValorCuotaInicial" class="form-control">
								</div>
							</div>	
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label" style="width: 150px; margin-left: 100px;">Numero de Cuotas:</label>
								<div class="col-lg-4">
		...
		<!-- SOLICITUDES EXTENAS -->
		<!-- Modal Agregar Solicitud Externa -->
		<div class="modal fade" id="myModalAddExterna" tabindex="-1"
			role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
				...
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true" onclick="refresh()">&times;</button>
						<h4 class="modal-title">
							<span class="fa fa-user-plus"></span><label id="lblTituloE">Agregar
								Solicitud Externa</label>
						</h4>
					</div>
					<div class="modal-body" style="padding-bottom: 0px !important;">
						<div id="idMensajeEX"></div>
						<!-- FORM -->
						<form class="bs-example form-horizontal u-action-error">
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label"> Tipo
									Solicitud:</label>
								<div class="col-lg-4">
									<select id="cboTipoSolicitudE" class="form-control">
										
									</select>
								</div>
								<label for="inputEmail1" class="col-lg-2 control-label">Archivo:</label>
								<div class="col-lg-4">
									<input type="file" id="txtFileE" alt="No hay archivo" class="form-control">
								</div>
							</div>
							<hr>
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" id="txtEmpresaE" class="form-control">
								</div>
							...
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label">
									Tecnología :</label>
								<div class="col-lg-4">
									<select id="cboTecnologiaE" class="form-control">
								...
								<label for="inputEmail1" class="col-lg-2 control-label">
									Privilegio :</label>
								<div class="col-lg-4">
									<select id="cboPrivilegioE" class="form-control">
							...
							<div class="form-group">
								...
								<div class="col-lg-4">
									...
									<textarea id="txtJustificacionE" class="form-control" rows=""
								...
								<div class="col-lg-4">
									...
									<textarea id="txtComentarioE" class="form-control" rows=""
										cols=""></textarea>
								</div>
							</div>		
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label for="inputEmail1" class="col-lg-2 control-label"> Acepto
									condiciones :</label>
								<div class="col-lg-4">
									<input type="checkbox" id=chkAceptoE required="required">
								</div>
							</div>
							<!-- /FORM -->
					...
					<div class="modal-footer" >
						<input type="hidden" id="txtAccionE" value="RegistroE" /> 
						<input type="hidden" id="txtIdentSolicitudE" /> 
						<input type="hidden" id="hdnEquipoE" />
						<table align="right">
							<tr>
								<td>
									<button style="display: none" class="btn btn-primary" id='estado2' type="button"
										onclick="rechazar('E')">
	...
	function CrearFondo()
	{
		var NombreFondo = $('#txtNombreFondo').val();
		var ValorCuotaInicial = $('#txtValorCuotaInicial').val();
		var NumeroCuotas = $('#txtNumeroCuotas').val();
		var accion = "CrearFondo";
		debugger;
		if(NombreFondo!="" && ValorCuotaInicial!="" && NumeroCuotas!="")
		{
			var parametros = {"accion":accion,"NombreFondo":NombreFondo,"ValorCuotaInicial":ValorCuotaInicial,
