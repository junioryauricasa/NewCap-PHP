					...
					<div class="panel panel-default" id="importacion">
						<div class="panel-heading">
							<strong><span id="omenu" class="fa fa-chevron-circle-left"></span>
								Operaciones</strong> <span class="pull-right"><span id="oprincipal" class="fa fa-chevron-circle-up"></span>						
						</div>
							...
							<div class="table-responsive u-table-search">
								...
								<table id="principal"
									...
									<tbody id="BandejaOperaciones">
										<?php
										$ct=0;
										$query = $Clientes->ObtenerOperacione($_SESSION['idUsuario']);
										...
										<tr>
											...
											<td><?php echo number_format($var['cantidad'],7,'.',','); ?></td>
											<td><?php echo number_format($var['NcuotasAgregado'],7,'.',','); ?></td>
											<?php 
											if($var['tipo'] == "APORTE")
											{	
