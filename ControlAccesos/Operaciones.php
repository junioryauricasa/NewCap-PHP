...
if ($_SESSION['usuario']) {
	...
	<title>New Capital - Operaciones</title>
					...
					<div class="panel panel-default" id="importacion">
						<div class="panel-heading">
							<strong><span id="omenu" class="fa fa-chevron-circle-left"></span>
								Operaciones</strong> <span class="pull-right"><span
						...
						<div class="panel-body">
								...
								<nav id="bprincipal" class="navbar navbar-default navbar-inverse"
									...
									<div class="navbar-collapse  navbar-filter">
										...
										<a class="btn btn-default"
											...
											class="fa fa-user-plus"></span> Realizar operacion
										</a> &nbsp;&nbsp; 
									</div>
									<br>
								</nav>	
							...
							<div class="table-responsive u-table-search">
								...
								<table id="principal"
									...
									<?php
									$query = $Operaciones->ObtenerOperaciones('','','','');
									...
									?>	
										<tr>
											...
											<td><?php echo$var['TipoOperacion']; ?></td>
											<td><?php echo$var['montoEjecutado']; ?></td>
											<td><?php echo$var['saldoAnterior']; ?></td>
											<td><?php echo$var['nuevoSaldo']; ?></td>
											<td>
												<a href=# onclick="AbrirPopupEliminar(<?php echo$var['idHistorialoperaciones']; ?>)">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span class="fa fa -"></span><label id="lblTituloE">Realizar operacion</label>
						</h4>
					</div>
					<div class="modal-body" style="padding-bottom: 0px !important;">
						...
						<form class="bs-example form-horizontal u-action-error">
							<div class="form-group">
								...
								<div class="col-lg-4">
									<select id="txtMiUsuario" class="form-control" onchange="ObtenerSaldoActual()">
										<?php									
										$queryFon = $Usuario->ObtenerBandejaUsuariosAcciones('','','');
	...
	function ObtenerSaldoActual(){
		var idUsuario = $('#txtMiUsuario').val();
		var accion = "ObtenerSaldoActual";
	...
	function AgregarAporte()
	{
		...
		if(Tipo=="R"){
			if(Saldo == "" || Monto == ""){
				alert("El campo saldo o monto no pueden estar en blanco");
			}else{
				if(Monto>Saldo){
					alert("No puede elegir un monto de retiro mayor al saldo actual");
				}
				else{
					var accion = "AgregarOperacion";
					if(idUsuario!="" && Tipo!="" && Monto!="" )
					{
						var parametros = {"accion":accion,"idUsuario":idUsuario,"Tipo":Tipo,
											"Monto":Monto};
	...
	function AbrirPopupEliminar(idOperacion)
	{
		var answer = confirm("Esta Seguro que quiere eliminar la operacion?")
		if (answer){
			var accion = "EliminarOperacion";
		    var parametros = {"accion":accion,"idOperacion":idOperacion};
			$.ajax({
				data:  parametros,
				url:   'Controlador/OperacionesController.php',
				type:  'post',
