...
if ($_SESSION['usuario']) {
	...
	<title>New Capital - Ejecutivos</title>
					...
					<div class="panel panel-default" id="importacion">
						<div class="panel-heading">
							<strong><span id="omenu" class="fa fa-chevron-circle-left"></span>
								Ejecutivos</strong> <span class="pull-right"><span
							...
							<div class="nav">
								<nav id="bprincipal" class="navbar navbar-default navbar-inverse"
									...
									<div class="navbar-collapse  navbar-filter">
											...
											class="fa fa-user-plus"></span> Crear Ejecutivo
										</a> &nbsp;&nbsp; 
									</div>
									<br>
								</nav>	
								...
								<table id="principal"
									...
									?>	
										<tr>
											...
											<td><a href=# onclick="AbrirPopupEliminar(<?php echo$var['idEjecutivos']; ?>)">
					...
					<div class="modal-body" style="padding-bottom: 0px !important;">
						...
						<form class="bs-example form-horizontal u-action-error">
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" id="txtNombreEjecutivo" class="form-control">
								</div>
							</div>	
							<div class="form-group">
								<label for="inputEmail1" class="col-lg-2 control-label" style="width: 150px; margin-left: 100px;">Comision:</label>
								<div class="col-lg-4">
									<input type="text" id="txtValorComision" class="form-control">
								</div>
							</div>	
	...
	{
		var NombreEjecutivo = $('#txtNombreEjecutivo').val();
		var ValorComision = $('#txtValorComision').val();
		var accion = "CrearEjecutivo";
		
		
		debugger;
		if(NombreEjecutivo!="" && ValorComision!="")
		{
			var parametros = {"accion":accion,"NombreEjecutivo":NombreEjecutivo,"ValorComision":ValorComision};
			$.ajax({
			        data:  parametros,
			        url:   'Controlador/EjecutivoController.php',
			        type:  'post',
	...
	function AbrirPopupEliminar(idEjecutivo)
	{
		var answer = confirm("Esta Seguro que quiere eliminar el Ejecutivo?")
		if (answer){
			var accion = "EliminarEjecutivo";
		    var parametros = {"accion":accion,"idEjecutivo":idEjecutivo};
			$.ajax({
				data:  parametros,
				url:   'Controlador/EjecutivoController.php',
				type:  'post',
